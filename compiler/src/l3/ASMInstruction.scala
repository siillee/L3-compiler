...
trait ASMInstructionModule {
  ...
  case class JNE(a: ASMRegister, b: ASMRegister, d: Constant)
      extends Instruction
  case class JUMP_I(a: ASMRegister) extends Instruction
  case class JUMP_D(d: Label) extends Instruction

  case class CALL_I(a: ASMRegister, b: ASMRegister) extends Instruction
  case class CALL_D(a: ASMRegister, d: Label) extends Instruction
